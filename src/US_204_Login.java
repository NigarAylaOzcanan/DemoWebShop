...
public class US_204_Login<dependsOnMethods, priority> extends BaseDriver {
    ...
    public void login() {
        ...
        // Valid password
        WebElement passwordd = driver.findElement(By.xpath("//input[@id='Password' and @name='Password']"));
        ...
        WebElement successfullLogin = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(text(),'TestUser_1234@gmail.com')]")));
